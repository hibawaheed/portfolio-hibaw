        ...
        <SlideInLeft className="flex flex-col justify-center">
          ...
          <div className="code-block">
            <p className="mb-6 text-xl leading-relaxed text-gray-300">
              My journey in the tech world started with simple coding projects and the thirst for  <span className="neon-highlight">money</span>, and has evolved into a deep
              exploration of various tech domains
            </p>
            <p className="mb-6 text-xl leading-relaxed text-gray-300">
              ...
              skill set and desperately try to outrun this turbo-charged hamster wheel of progress before it leaves you coding in ancient Greek.
            </p>
            <p className="text-xl leading-relaxed text-gray-300">
              My goal is to become a versatile <span className="neon-highlight">Rich IT professional</span> who can bridge
              the gap between theoretical knowledge and practical applications, creating{" "}
              solutions that make a difference in my <span className="neon-highlight"> bank account</span>.
            </p>
          </div>
        </SlideInLeft>
          ...
          <div className="relative z-10 h-full w-full overflow-hidden rounded-2xl border border-teal-500/30 bg-gray-900/50 p-8">
            ...
            <div className="mt-4 text-center">
              ...
              <p className="mt-4 text-lg text-gray-400">
                I plan to shoot my shot at top universities in the U.S. or Canada — you know, casual names like MIT, the University of Toronto, or Waterloo — all while hoping my SAT scores look less like my screen brightness at 2 a.m. The goal? Expand my knowledge, cry through some academic challenges, and maybe walk out with a future that’s not held together by caffeine and prayer.
              </p>
            </div>
          </div>
        </SlideInRight>
            ...
            <CardContent className="p-0">
              <div className="border-b border-gray-800 p-8">
                ...
                <p className="text-base text-gray-300 code-text">
                  Focusing on my IGCSEs while actively participating in co-curricular activities and serving as the Vice President of the IT Society moe wmow 
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="border-gray-800 bg-gray-900/50">
            <CardContent className="p-0">
              <div className="border-b border-gray-800 p-8">
                ...
                <ul className="ml-6 list-disc space-y-2 text-base text-gray-300">
                  <li className="code-text">
                    Built and maintained the official Grammafest website
                  </li>
                  <li className="code-text">
                    Managed delegate communication through the website forum
                  </li>
              ...
              <div className="p-8">
                ...
                <ul className="ml-6 list-disc space-y-2 text-base text-gray-300">
                  <li className="code-text">
                    Led the Appventure category planning and execution at PYCST
                  </li>
